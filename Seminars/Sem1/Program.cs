...
// Напишите программу, которая на вход принимает трёхзначное число и на выходе показывает **псоледнюю** цифру этого числа.
...
//if(a == b*b)
//{
//    System.Console.Write($"{a} is quad {b}");
//}
//else
//{
//    System.Console.Write($"{a} is not quad {b}");
//}

// Задачи решеные на семинаре вместе с преподователем
